...
if (limit == 0) return msg.channel.send("**Yavaşmod Başarıyla Kaldırıldı! Tekrar Açmak İçin !slownode [Limit] Yazmalısın!**");
return msg.channel.send(`**Sunucudaki Kullanıcılar Bundan Sonra **${limit}** Bu Süre Aralığıyla Mesaj Atabielcek! ** :shield:`);
